...
public final class ActivitySignInBinding implements ViewBinding {
  ...
  private ActivitySignInBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView appleIcon,
      @NonNull EditText emailInput, @NonNull ImageView facebookIcon,
      @NonNull TextView forgotPassword, @NonNull ImageView googleIcon, @NonNull Button loginButton,
      @NonNull TextView loginSubtitle, @NonNull TextView loginTitle, @NonNull ConstraintLayout main,
      @NonNull TextView orText, @NonNull EditText passwordInput, @NonNull TextView signUpLink,
      @NonNull TextView signUpLink1, @NonNull LinearLayout socialLoginContainer) {
  ...
  public static ActivitySignInBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySignInBinding((ConstraintLayout) rootView, appleIcon, emailInput,
          facebookIcon, forgotPassword, googleIcon, loginButton, loginSubtitle, loginTitle, main,
          orText, passwordInput, signUpLink, signUpLink1, socialLoginContainer);
    }
