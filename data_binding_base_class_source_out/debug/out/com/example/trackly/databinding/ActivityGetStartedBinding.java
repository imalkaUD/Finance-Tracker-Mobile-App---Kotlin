...
public final class ActivityGetStartedBinding implements ViewBinding {
  ...
  private ActivityGetStartedBinding(@NonNull ConstraintLayout rootView, @NonNull Button SignIn,
      @NonNull Button SignUp, @NonNull ImageView imageView2, @NonNull ConstraintLayout main) {
  ...
  public static ActivityGetStartedBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityGetStartedBinding((ConstraintLayout) rootView, SignIn, SignUp, imageView2,
          main);
    }
